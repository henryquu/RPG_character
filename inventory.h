...
/**
 * @brief Item structure with some basic stats and pointer to the next item
 */
struct Item {
    /// Name of the item
    std::string name;
    ...
    /// Used when couting full stats and checking for type lost availability
    bool equipped = false;
    /// Weight of the item
    int weight = 0;
    ...
    /**
     * @brief Save item into the file stream
...
/**
 * @brief Counts weight of the whole inventory
...
/**
 * @brief Counts available inventory weight
 * @param ptr ptr to the inventory
...
/**
 * @brief Checks if item is of weapon type
 * @param type type
...
/**
 * @brief Checks if the type is already equipped in the inventory
 * @param ptr ptr to the inventory
...
/**
 * @brief Counts base stats from equipped items
...
/**
 * @brief Adds item to the end of the inventory
...
/**
 * @brief Deletes item from the inventory
 * by using it's name
 * @param head ptr to the inventory
...
/**
 * @brief Deletes the inventory from the memory
 * @param head ptr to the inventory
 */
void delete_inventory(Item *&head);

/**
 * @brief Creates an item of chosen type
 * @param name name
 * @param type type of the item
...
/**
 * @brief Save inventory into a file
...
/**
 * @brief Loads an item from a file stream
...
/**
 * @brief Loads inventory of a character
